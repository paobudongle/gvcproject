...
import org.frameworkset.platform.common.SessionMapUtil;
...
public class SessionListener implements javax.servlet.http.HttpSessionAttributeListener,HttpSessionListener{
	...
	public void sessionDestroyed(HttpSessionEvent event) {
		...
		if(session!=null){
			Principal principals = (Principal) session.getAttribute(AccessControl.PRINCIPAL_INDEXS);
			if(principals != null)
			{
				AccessControl.logoutdirect(session);
				SessionMapUtil.delOnlineUser(principals.getName());
			}
