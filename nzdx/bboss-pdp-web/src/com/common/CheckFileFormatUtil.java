...
//		System.out.println(mFileTypes.get(getFileHeader(filePath)));
    ...
    public static String getMultipartFileType(MultipartFile file) {
        return mFileTypes.get(getMultipartFileHeader(file));
    }
...
//		System.out.println(builder.toString());
    ...
    public static String getMultipartFileHeader(MultipartFile file) {
        InputStream is = null;
        String value = null;
        try {
    ...
    public static void main(String[] args) throws Exception {
        final String fileType = getFileType("/Users/any/Downloads/1/0/1.pdf");
        System.out.println(fileType);
        System.out.println(getFileHeader("/Users/any/Downloads/1/0/1.pdf"));
    }
}
