var PlatformCommonUtils = function(){
	...
	var loading = function(msg,loadingfun){
		swal({
			  title: msg,
			  text: "",
			  type:"info",
	...
	return {
        loading:function(msg,loadingfun){
            loading(msg,loadingfun);
        },
		unloading:function(){
            unloading();
        },
...
//		 $modals.push( _modal);
	...
	return {
        ...
        loading:function(msg,loadingfun){
            PlatformCommonUtils.loading(msg,loadingfun);
        },
		unloading:function(){
            PlatformCommonUtils.unloading();
        },
		warn:function(msg,warnfun){
