...
<script type="text/javascript">
        ...
        PDP.validateform({
            ...
            rules: {
                jzTitle: {
                    required: true,
                    remote: {          //远程ajax验证
                        url:  usercontextpath + '/modeljz/checkJzName.page', //检查是否存在重名
                        type: "GET",
                        dataType: "json",
                        data: {
                            jzTitle: function () {
    ...
    function CreateSymbTable(){
        var url = usercontextpath + '/modeljz/querySymbJzMain.page';
        $.post(url, {},
            function (symbList) {
    ...
    function valiRow() {
        ...
        var role3 =<%=UserUtils.isHasRole("trialglobalmodel")%>;
