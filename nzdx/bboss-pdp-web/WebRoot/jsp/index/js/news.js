...
METUI_FUN['news_list_page_met_16_3'] = {
    name:'news_list_page_met_16_3',
    position:function(){
        var a=METUI['news_list_page_met_16_3'].find('.col-md-3');
        var b=METUI['news_list_page_met_16_3'].find('.pright');
...
var x = new metui(METUI_FUN['news_list_page_met_16_3']);
