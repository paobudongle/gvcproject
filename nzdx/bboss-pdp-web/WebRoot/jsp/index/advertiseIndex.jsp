            ...
            <div class="col-md-9 met-news-body     ">
                ...
                <div class="met-news-list">
                    <ul class="ulstyle met-pager-ajax imagesize" data-scale='400x400' m-id='10'>
                        ...
                        <c:forEach items="${advertiseList.datas}" var="advertise">
                            <!-- 极简模式 -->
                            <li class='border-bottom1'>
                                <h4>
                                    <a href="<%=request.getContextPath()%>/index/toAdvertise.page?advertiseId=${advertise.advertiseId}" title="${advertise.advertisePosition}"
                                       target="_blank">${advertise.advertisePosition}</a>

                                    <span style="float:right;">薪资:${advertise.workWage}</span>
                                </h4>
                                ...
                                <p class="info font-weight-300">
                                    <span>招聘单位:${advertise.advertiseCompany}</span>
                                    <span></span>
                                    <span >工作地点:${advertise.workAddress}</span>
                                    <span></span>
                                    <span style="float:right;">发布日期:${advertise.releaseDate}</span>
                                </p>
                            </li>
                    ...
                    <div class='m-t-20 text-xs-center hidden-sm-down' m-type="nosysdata">
                        ...
                        <div class='met_pager'>
                            ...
                            <c:if test="${totalPage > 0}">
                                ...
                                <c:if test="${currentPage != 1}">
                                    <a href="${pageContext.request.contextPath}/index/toAdvertiseIndex.page?offset=${prePage}&currentPage=${currentPage - 1}" class="PreA">上一页</a>
                                </c:if>
                                ...
                                <c:forEach var="nums" begin="1" end="${totalPage > pagesize ? pagesize : totalPage}" step="1">
                                    <a <c:if test="${nums == currentPage}">
                                        class='Ahover'
                                            ...
                                            href='${pageContext.request.contextPath}/index/toAdvertiseIndex.page?offset=${(nums-1) * pagesize}&currentPage=${nums}' >${nums}</a>

                                </c:forEach>

                                <c:if test="${currentPage != totalPage}">
                                    <a href='${pageContext.request.contextPath}/index/toAdvertiseIndex.page?offset=${nextPage}&currentPage=${currentPage + 1}' class='NextA'>下一页</a>
                                </c:if>
            ...
            <div class="col-md-3">
                <div class="row">
                    <aside class="sidebar_met_16_1 met-sidebar panel panel-body m-b-0" boxmh-h m-id='35' m-type='nocontent'>
                        <form class='sidebar-search' method='get' action="${pageContext.request.contextPath}/index/toAdvertiseIndex.page">
                        ...
                        <ul class="sidebar-column list-icons">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/index/toAdvertiseIndex.page" title="招聘信息" class='active'>招聘信息</a>
                            </li>
                        </ul>
