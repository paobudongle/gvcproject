    ...
    <div class="portlet-body form">
        <form action="#" class="form-horizontal form_addjz" id="form_addjz" enctype="multipart/form-data">
            <div class="form-body" style="padding-top: 10px;">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-2 control-label" style="text-align: right">案例文件<span class="required">*</span></label>
                        <div class="col-md-10">
        ...
        var addProduct = function () {
            $('form', ModelDialog.getCurrentModal())
                .ajaxSubmit(
                    {
                        type: 'POST',
                        url: usercontextpath + '/modeljzi/impCaseExcel.page',
                        forceSync: false,
                        dataType: 'json',
                        ...
                        success: function (responseText, statusText, xhr, $form) {
                            ...
                            if (msg.flag == 'success') {
                                ...
                                PDP.success("导入成功!", function () {
                                    ModelDialog.getCurrentModal().modal('hide');
                                    $("#colsure").val(msg.colsureType);
                                    $("#colsure").trigger("change");
                                    $("#closureTxt").val(msg.colsure);
                                    $("#jzId").val(msg.mdId);
                                   /* if(msg.colsureType == 'SelfClosure') {
                                        $("#closureTxt").css("display", "block");
                                    }else{
                                        $("#closureTxt").css("display", "none");
                                    }*/
                                    $("#shorckTxt").val(msg.shorck);
                                    setTab('2');
                                });
                            } else {
                                PlatformCommonUtils.warn("导入失败!");
                            }
                        }
                    });
