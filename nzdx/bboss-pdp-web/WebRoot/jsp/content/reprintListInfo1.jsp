...
<pg:pager scope="request" data="reprint" containerid=".portlet-Contentlist2">
    <pg:param name="crawlId" value="1"/>
    <!-- 加入 class="tableOutline" 可控制表格宽度，滚动条展示 -->
    <table class="table table-bordered table-striped table-condensed table-Contentlist2">
        <thead>
        <pg:header>
            <th width="2%"><input type="checkbox" class="checkboxall"
                                  onClick="checkAll('.table-Contentlist2 .checkboxall','.table-Contentlist2 .checkone')"/>
            </th>
            <th width="2%">序号</th>
            <th>资讯标题</th>
            <th>栏目</th>
        ...
        <pg:list>
            ...
            <tr>
                <td><input
                        ...
                        onClick="checkOne('.table-Contentlist2 .checkboxall','.table-Contentlist2 .checkone')"
                ...
                <td title="<pg:cell colName="crawlTitle"/>">
                    <pg:cell colName="crawlTitle" maxlength="15"/>...
